...
def main():
    ...
    if current_question_index < len(questions):
        ...
        # Display question number and question text in the same line
        st.markdown(
            f"""
            <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 20px;">
                <h3 style="color: #2196F3; margin: 0 10px 0 0; font-family: 'Arial', sans-serif;">Q{current_question_index + 1}:</h3>
